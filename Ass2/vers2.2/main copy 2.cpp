        ...
        if (i % refresh_tracker == 0)
        {
            ...
            for (int k = 0; k < new_ROIs.size(); k++)
            {
                ...
                for (int l = k + 1; l < new_ROIs.size(); l++)
                {
                    ...
                    //     {
                    //         // r1 inside r2
                    //         if ((float)r3.area() / (float)r1.area() > 0.8)
                    //         {
                    //             add_flag = true;
                    ...
                    //     else
                    //     {
                    //         if ( (float)r3.area() / (float)r2.area() > 0.8)
                    //         {
                    //             //tmp_tmp_new_ROIs.push_back(r1);
                    //             add_flag = false;
                    //             break;
                    ...
                    if (r3.area() > 0)
                    {
                        ...
                        else if (r4 / (float)r3.area() > 0.6)
                        {
                            ...
                            // {
                            //     // r1 inside r2
                            //     if ((float)r3.area() / (float)r1.area() > 0.9)
                            //     {
                            //         add_flag = true;
                            //         //tmp_tmp_new_ROIs.push_back(r1);
                            //     }
                            ...
                            // else
                            // {
                            //     if ((float)r3.area() / (float)r2.area() > 0.9)
                            //     {
                            //         //tmp_tmp_new_ROIs.push_back(r1);
                            //         add_flag = false;
                            //         break;
